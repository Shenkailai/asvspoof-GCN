...
if __name__ == '__main__':
    ...
    # Dataset
    parser.add_argument('--database_path', type=str, default=r'D:\研究生\研一上\ASVspoof2021-DF\data/ASVspoof_database/DF/',
    ...
    parser.add_argument('--protocols_path', type=str,
                        default=r'D:\研究生\研一上\ASVspoof2021-DF\protocols/ASVspoof_database/',
